...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { data: @feature.data, description: @feature.description, name: @feature.name, report: @feature.report }
    end
  ...
  test "should update feature" do
    patch :update, id: @feature, feature: { data: @feature.data, description: @feature.description, name: @feature.name, report: @feature.report }
    assert_redirected_to feature_path(assigns(:feature))
  end
